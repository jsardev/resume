...
**Technologies:** TypeScript, React, Next.js, SCSS, Contentstack, Vercel, GitHub Actions, Jira, Confluence
...
**Technologies:** TypeScript, React, Astro, React Router, React Query, XState, Phaser, Tailwind, GritQL, GitHub Actions, Jira, Confluence
...
**Technologies:** TypeScript, React, GSAP, React Aria, Storybook, Tailwind, UnoCSS, GitLab Pipelines, Jira, Notion
...
**Technologies:** TypeScript, Node.js, React, Next.js, Razzle, Redux, MobX, Storyblok, Google Cloud, Jira, Confluence
...
- Customized a CMS for the marketing team to easily launch campaigns, integrating it with the storefront for dynamic content.

**Technologies:** TypeScript, React, Next.js, Redux, Redux Form, Reselect, Strapi, GitHub Actions, Jira, Confluence
...
- Improved the client's conversion rate by 20% through a custom-coded landing page.

**Technologies:** JavaScript, Next.js, React, Fastify, Ramda, Stripe, GitHub Actions, Trello
...
- Maintained and improved outdated systems, optimizing resource usage.

**Technologies:** JavaScript, React, Redux, Node.js, Koa, Express, Java, Kotlin, Spring, PHP, Symfony, Kafka, Hermes, Consul, Mesos, Marathon, Bamboo, Jira, Confluence
...
**Technologies:** JavaScript, React, Redux, Java, Spring, Bamboo, Jira, Confluence
...
**Technologies:** JavaScript, Java, Selenium, Selenium Grid, JMeter, Bamboo, Jira, Confluence
...
**Technologies:** C#, .NET, Angular, Elasticsearch, log4net, Redmine
...
- Collaborated with the development team to improve test coverage and testing processes for the analytics platform.

**Technologies:** C#, Selenium, Redmine
